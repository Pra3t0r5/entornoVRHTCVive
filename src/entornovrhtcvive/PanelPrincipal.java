...
import static entornovrhtcvive.VisualStyler.*;
...
public class PanelPrincipal extends javax.swing.JFrame {
    ...
    private void inicializarInterfaz() throws NumberFormatException {
        initComponents();
        chkAlargarTiempoDeJuego.setBackground(Color.decode(colorBackground));
        chkAlargarTiempoDeJuego.setForeground(Color.decode(colorText2));
        chkVerInterfaz.setBackground(Color.decode(colorBackground));
        chkVerInterfaz.setForeground(Color.decode(colorText2));
        coinListener.setBackground(Color.decode(colorBackground));
        coinListener.setForeground(Color.decode(colorBackground));
        txtFieldPasswordServicio.setBackground(Color.decode(colorText2));
        txtFieldPasswordServicio.setForeground(Color.decode(colorBackground));
        cmbJugadoresHabilitados.setBackground(Color.decode(colorText2));
        cmbJugadoresHabilitados.setForeground(Color.decode(colorBackground));
    ...
    private void initComponents() {
        ...
        lblValorJuego = new entornovrhtcvive.VisualStyler.mdLabel("sec");
        lblTitulo = new entornovrhtcvive.VisualStyler.mdLabel("pri");
        lblPaseTarjeta = new entornovrhtcvive.VisualStyler.mdLabel("sec");
        ...
        lblCantJugadasTotal = new entornovrhtcvive.VisualStyler.mdLabel("ter");
        lblJugadoresHabilitados = new entornovrhtcvive.VisualStyler.mdLabel("con");
        ...
        lblJugadoresHabilitados.setText("JUGADORES HAB.");
        ...
        chkAlargarTiempoDeJuego.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        chkAlargarTiempoDeJuego.setText("EXTENDER PARTIDA");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(chkAlargarTiempoDeJuego, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(cmbJugadoresHabilitados, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
